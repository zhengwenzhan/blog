package com.wenzhan.blog.cache;

import com.wenzhan.blog.entity.Blog;
import com.wenzhan.blog.entity.Tag;
import com.wenzhan.blog.entity.Type;
import com.wenzhan.blog.enums.RedisKeyEnum;
import com.wenzhan.blog.service.BlogService;
...
public class RedisCache {
    ...
    public long getBlogNum() {
        String blogViewsKey = RedisKeyEnum.BLOGVIEWS.getRedisKey();
        String blogScoreKey = RedisKeyEnum.BLOGSCORE.getRedisKey();
        ...
        try {
            ...
            if (CollectionUtils.isEmpty(blogSet)) {
                ...
                if (CollectionUtils.isEmpty(allBlogId)) {
                    return blogNum;
                }

                allBlogId.forEach(blogId -> {
                    Blog blog = blogService.getBlogInfoById(Integer.parseInt(blogId));
                    int num = blog.getBrowse();
                    jedis.zadd(blogScoreKey, num, blogId);
                });
